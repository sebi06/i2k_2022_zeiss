...
def get_czimetadata_dict_complete(filename: str, sort: bool = True) -> Dict:
    """Return the complete CZI metadata as a sorted dictionary.

    Args:
        filename (str): filename of the CZI file
        sort (bool, optional): Option to return a sorted dictionary. Defaults to True.

    Returns:
        Dict: (sorted) dictionary with the complete CZI metadata
    """
